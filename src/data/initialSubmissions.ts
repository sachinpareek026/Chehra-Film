...
export const INITIAL_ACTOR_SUBMISSIONS: ActorSubmission[] = [
  {
    ...
    selectedRole: 'ANY OTHER ROLE — Open Character Canvas',
    personalityAndSkills: 'High endurance climber, silent expressive gaze, authentic high-altitude survival experience',
    usefulRoleTarget: 'A high-altitude solitary wanderer or unscripted mountain local',
